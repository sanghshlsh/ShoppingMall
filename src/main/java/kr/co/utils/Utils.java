...
public class Utils {
	...
	public static String saveFile(String originalName, MultipartFile file, String uploadPath) throws Exception {
		...
		String newName = Utils.makeNewName(originalName);//filename이 newname
		...
		boolean isimgFile = isTmg(originalName);
	...
	public static String makeThumbnail(String uploadPath, 
		...
		String format = newName.substring(idx+1);
	...
	public static boolean isTmg(String filename) {
